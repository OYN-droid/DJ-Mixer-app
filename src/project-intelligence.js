(function initializeProjectIntelligence(global) {
  ...
  function getContextSummary(options = {}) {
    ...
    if (include.has("stems")) summary.stems = { separatedTracks: context.stems.separatedTracks, availableStemTypes: context.stems.availableStemTypes, selectedStem: context.stems.selectedStem, processingState: context.stems.processingState, processingQueue: context.stems.processingQueue, activeGraph: context.stems.activeGraph, localTransport: context.stems.localTransport, serverAvailable: context.stems.serverAvailable };
